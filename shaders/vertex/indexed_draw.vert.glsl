...
void main() {
    Vertex2 v = obj_data_2.vertex_buffer.vertices[gl_VertexIndex];
    gl_Position = scene_data.view_proj * (obj_data_2.local_transform * vec4(v.pos.xyz, 1.f) + vec4(constants.pos, 1.f));
    frag_color = (obj_data_2.local_transform * vec4(v.norm.xyz, 1.f)).xyz;
