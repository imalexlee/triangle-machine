 ...
 */
[[nodiscard]] PipelineInfo build_pipeline(const PipelineBuilder* pb, VkDevice device);
 ...
 */
void set_pipeline_shaders(PipelineBuilder* pb, VkShaderModule vert_shader, VkShaderModule frag_shader, const char* entry_name = "main");
