...
void editor_init(Editor* editor, Renderer* backend, struct Camera* camera, GLFWwindow* window);

void editor_update(Editor* editor, Renderer* backend, const Window* window, struct Camera* camera, struct Scene* scene);
